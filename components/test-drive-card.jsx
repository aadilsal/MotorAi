    ...
    <>
      ...
      >
        <div className="flex flex-col sm:flex-row">
          ...
          <div className="p-4 sm:w-3/4 sm:flex-1">
          ...
          {showActions && (
            <div className="p-4 border-t sm:border-t-0 sm:border-l sm:w-1/4 sm:flex sm:flex-col sm:justify-center sm:items-center sm:space-y-2">
              {booking.notes && (
                <div className="bg-gray-50 p-2 rounded text-sm w-full mb-2">
              ...
              {/* Cancel button with Dialog - only show if onCancel is provided and booking can be cancelled */}
              {onCancel && canCancel && (
                <Dialog
                  ...
                  <DialogContent>
                    <DialogHeader>
                      ...
                      <DialogDescription>
                        ...
                        {booking.car.model}? This action cannot be undone.
                      </DialogDescription>
                    </DialogHeader>
